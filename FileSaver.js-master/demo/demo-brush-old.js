...
$(document).ready(function(e) {
	var topbar_height = document.getElementsByClassName("topbar").height;
	var width = (window.innerWidth > 0) ? window.innerWidth : screen.width;
	var height = (window.innerHeight > 0) ? window.innerHeight : screen.height;
	document.getElementById("canvas").width =
	document.getElementsByTagName('body')[0].width =
		width - 2;
	document.getElementById("canvas").height = height - topbar_height - 2;
	document.getElementById("canvas").css
		({
         	top:topbar_height;
        });
	...
	document.getElementsByClassName("topbar").width = width;
